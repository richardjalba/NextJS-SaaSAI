...
export default async function handler(req, res) {
  ...
  const keywords =
    'Common dog owner issues, Best toys for dogs, Most popular dog breeds';
...
The response must also include appropriate HTML title and meta description content. The return format must be stringified JSON in the following format: 
    {
