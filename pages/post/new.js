...
export default function NewPost(props) {
  ...
  return (
    <div className='h-full overflow-hidden'>
      {!!generating && (
        <div className='text-green-800 flex h-full animate-pulse w-full flex-col justify-center items-center'>
          <FontAwesomeIcon icon={faFeather} className='text-8xl' />
        </div>
      )}
      {!generating && (
        <div className='w-full h-full flex flex-col overflow-auto'>
          ...
          >
            <div>
              <label>
                <strong>Generate content on the following topic:</strong>
              </label>
              <textarea
